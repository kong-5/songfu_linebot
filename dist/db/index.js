...
function initSqlite(dbPath) {
    ...
    try {
        ...
        // 盤點校準基準（調整單）：一倉一品項一筆已接受的真實量；設定後盤差＝實盤−基準
        sqlite.exec("CREATE TABLE IF NOT EXISTS stocktake_baseline (wh_code TEXT NOT NULL, erp_code TEXT NOT NULL, baseline_qty REAL, source_session_id TEXT, source_date TEXT, adjusted_by TEXT, adjusted_by_name TEXT, adjusted_at TEXT, note TEXT, PRIMARY KEY (wh_code, erp_code))");
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                await client.query("CREATE TABLE IF NOT EXISTS stocktake_baseline (wh_code TEXT NOT NULL, erp_code TEXT NOT NULL, baseline_qty DOUBLE PRECISION, source_session_id TEXT, source_date TEXT, adjusted_by TEXT, adjusted_by_name TEXT, adjusted_at TEXT, note TEXT, PRIMARY KEY (wh_code, erp_code))");
